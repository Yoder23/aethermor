...
browser-based interactive explorer (\texttt{app.py}) with six
...
The entire test suite (254~tests) and validation suite (133~checks)
...
\begin{center}
\url{https://github.com/Yodes94/aethermor}
\end{center}
